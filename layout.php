...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Devclub</a>
    ...
    <footer>
        <div class="text-center p-3 bi bi-c-circle" style="background-color: rgba(0, 0, 0, 0.2);">
             2030 Copyright : SENPRU
        </div>
    </footer>
